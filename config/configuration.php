...
class config
{
    ...
    /* Database */
    public $dbHost = '192.168.244.132'; //Database host
    public $dbUser = 't'; //Database username
    public $dbPassword = '1'; //Database password
    public $dbDatabase = 'leantime1'; //Database name
    public $dbPort = '3306'; //Database port

    /* Fileupload */
    public $userFilePath = '/mnt/nfsmount/local'; //Local relative path to store uploaded files (if not using S3)

    public $dbBackupPath = '/mnt/nfsmount/backup/'; //Local relative path to store backup files, need permission to write
